/*Код программы Buf_WR_IO_4 - чтение из одного файла и запись в другой файл данных построчно с использованием буферизации символьных потоков, основанных на байтовых файловых потоках.*/
import java.io.*;
